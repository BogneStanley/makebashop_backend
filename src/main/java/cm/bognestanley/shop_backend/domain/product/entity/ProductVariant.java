...
import cm.bognestanley.shop_backend.domain.product.exception.OutOfStockException;
...
public class ProductVariant {
    ...
    public void decreaseStock(int quantity) {
        ...
        if (!hasSufficientStock(quantity)) {
            throw new OutOfStockException("Insufficient stock. Available: " + stockQuantity + ", requested: " + quantity);
        }
